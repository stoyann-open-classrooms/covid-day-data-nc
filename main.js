...
const testimonials = [
  ...
  {
    name: "Louis Mapou",
    position: "Président du 17eme Gouvernement",
    photo:
      "https://i1.wp.com/www.radio1.pf/cms/wp-content/uploads/2021/07/Louis-Mapou.jpg?fit=800%2C511&ssl=1",
    text: " Prolongement du confinement strict jusqu'au 4 Octobre a minuit. Les mêmes règles de confinement seront appliquées (restrictions, contrôles, couvre-feu…)",
  },
...
function enginestep() {
  ...
  ctx.textBaseline = "middle";
  ctx.fillText(
    "COVID - Game, remade by Yagi & originally developed by Hypertext Assasin",
    stage.w / 2,
    stage.h - 20
  );
}
